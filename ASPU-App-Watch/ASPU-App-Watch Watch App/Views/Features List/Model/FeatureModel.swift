...
struct AppFeatures {
    static let features = [
        ...
        FeatureModel(
            ...
            description: "С помощью свайпа можно получить информацию для разделов приложения. Например, количество пар, какие новости появились за сегодня, получить информацию о ближайшем корпусе или узнать текущую версию приложения. Также вы можете поставить основной раздел приложения в начало списка с помощью свайпа влево."
        )
    ]
}
