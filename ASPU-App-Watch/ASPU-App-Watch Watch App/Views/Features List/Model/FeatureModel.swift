...
struct AppFeatures {
    static let features = [
        ...
        FeatureModel(
            ...
            description: "С помощью свайпа можно узнать информацию для раздела \"Новости\" или \"Расписание\", например, количество пар или какие новости появились за сегодня."
        )
    ]
}
